 ...
 * The search cost of an element = search frequency * level.
 ...
 * 
 * Since we are adding the frequencies of left and right subtree alongwth the frequency of the parent element,
